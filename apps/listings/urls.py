...
from .views import (
    ...
    create_conversation_offer,
    appointment_action,
    bulk_manage_listings,
...
urlpatterns = [
    ...
    path("ilanlarim/", MyListingListView.as_view(), name="my_listings"),
    path("ilanlarim/toplu-islem/", bulk_manage_listings, name="bulk_manage_listings"),
    ...
    path("aramalar/<int:pk>/guncelle/", update_saved_search, name="update_saved_search"),
    ...
    path("mesajlar/<int:pk>/geri-al/", restore_conversation, name="restore_conversation"),
    path("mesajlar/<int:pk>/teklif/", create_conversation_offer, name="conversation_offer"),
    ...
    path("moderasyon/kullanici-sikayet/<int:pk>/<str:action>/", moderate_user_report, name="moderate_user_report"),
    path("moderasyon/risk/<int:pk>/<str:action>/", moderate_risk_event, name="moderate_risk_event"),
    ...
    path("konumumu-coz/", reverse_location, name="reverse_location"),
