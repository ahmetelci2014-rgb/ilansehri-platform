...
def main() -> int:
    ...
    seller_template = (ROOT / "templates/listings/my_listings.html").read_text(encoding="utf-8")
    seller_css = (ROOT / "static/css/v124-seller-center.css").read_text(encoding="utf-8")
    seller_js = (ROOT / "static/js/v124-seller-center.js").read_text(encoding="utf-8")
    communication_css = (ROOT / "static/css/v125-communication-center.css").read_text(encoding="utf-8")
    communication_js = (ROOT / "static/js/v125-communication-center.js").read_text(encoding="utf-8")
    conversation_list = (ROOT / "templates/listings/conversation_list.html").read_text(encoding="utf-8")
    ...
    require(base, "v124-seller-center.css", "templates/base.html")
    require(base, "v124-seller-center.js", "templates/base.html")
    require(base, "v125-communication-center.css", "templates/base.html")
    require(base, "v125-communication-center.js", "templates/base.html")
    ...
    require(views, "/static/css/v124-seller-center.css", "apps/core/views.py")
    require(views, "/static/js/v124-seller-center.js", "apps/core/views.py")
    require(views, "/static/css/v125-communication-center.css", "apps/core/views.py")
    require(views, "/static/js/v125-communication-center.js", "apps/core/views.py")
    ...
    require(seller_template, "data-v124-seller-center", "templates/listings/my_listings.html")
    require(seller_template, "data-v124-bulk-form", "templates/listings/my_listings.html")
    require(seller_template, "data-v124-listing-select", "templates/listings/my_listings.html")
    require(seller_css, ".v124-seller-stats", "static/css/v124-seller-center.css")
    require(seller_css, ".v124-listing-card", "static/css/v124-seller-center.css")
    require(seller_js, "data-v124-select-all", "static/js/v124-seller-center.js")
    require(conversation_list, "data-v125-inbox", "templates/listings/conversation_list.html")
    require(conversation_list, "mode=archived", "templates/listings/conversation_list.html")
    require(conversation_detail, "data-v125-conversation", "templates/listings/conversation_detail.html")
    require(conversation_detail, "data-v125-quick-reply", "templates/listings/conversation_detail.html")
    require(conversation_detail, "data-v125-offer-panel", "templates/listings/conversation_detail.html")
    require(offer_center, "data-v125-offer-center", "templates/listings/offer_center.html")
    require(offer_center, "direction=action", "templates/listings/offer_center.html")
    require(communication_css, ".v125-chat-layout", "static/css/v125-communication-center.css")
    require(communication_css, ".v125-offer-card", "static/css/v125-communication-center.css")
    require(communication_js, "data-v125-quick-reply", "static/js/v125-communication-center.js")
    require(audit, "conversation-detail", "scripts/mobile_audit.py")
    require(audit, "messages-action", "scripts/mobile_audit.py")
    require(audit, "my-listings-attention", "scripts/mobile_audit.py")
